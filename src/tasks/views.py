...
def task_list(request: HttpRequest) -> HttpResponse:
    ...
    if genai is None:
        ai_recommendation = "[Error: 'google-genai' package is not installed by your teammate.]"
    elif tasks.exists():
        tasks_text = "\n".join([
        ...
        try:
            client = genai.Client(api_key="AQ.Ab8RN6KFKLZfvB1a7FOAIxARMNHKV8wxpNJO9hDdNpZQ6vyGrg")
